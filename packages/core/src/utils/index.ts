...
export { default as hddcoinToMojo } from './hddcoinToMojo';
...
export { default as mojoToHDDcoin } from './mojoToHDDcoin';
export { default as mojoToHDDcoinLocaleString } from './mojoToHDDcoinLocaleString';
